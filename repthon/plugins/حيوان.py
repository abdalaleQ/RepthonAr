#𝙍𝙀𝙋𝙏𝙃𝙊𝙉 ®
#الملـف حقـوق وكتابـة الزعيم ⤶ @T_5_G خاص بسـورس ⤶ 𝙍𝙀𝙋𝙏𝙃𝙊𝙉
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝙍𝙀𝙋𝙏𝙃𝙊𝙉 𓆪 </b> - @VVV5P "
...
async def who(event):
    ...
    if replied_user.id == 6700336976 or replied_user.id == 6700336976 or replied_user.id == 6700336976:
