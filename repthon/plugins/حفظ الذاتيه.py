...
BaqirSelf_cmd = (
    "𓆩 [ᯓ حفـظ الذاتيـه سورس الزعيم🧧](t.me/VVV5P) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
